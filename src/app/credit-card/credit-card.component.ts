    ...
    getTDCsAndAccounts(showLoading = true) {
        ...
        this._cardsService.getTDCs(1).subscribe(
            response => {
                ...
                this.form.amount = this.form.number ? this.trunc((this.form.number.cc_balance * (this.form.number.cc_minimum_payment / 100)) + (this.form.number.cc_balance * (this.form.number.cc_interests / 100)), 2) : null;
